...
const createTables = async () => {
  try {
    ...
    // Create news table (using only author_id for referential integrity)
    await pool.query(`
...
const seedDatabase = async () => {
  try {
    ...
    const domainResults = await pool.query('SELECT id, name FROM domains');
    const domainMap = {};
    ...
    const users = [
      { username: 'tech_contributor', email: 'tech@company.com', password: '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', role: 'contributor', domain: domainMap['Technology'] },
      { username: 'business_contributor', email: 'business@company.com', password: '$2b$12$IuOYa/0K7Chf.ZbK4.0EIuBbEyqDLs1wDBg7Hu8Sf0s0p6rdFm.HS', role: 'contributor', domain: domainMap['Business'] },
      { username: 'design_contributor', email: 'design@company.com', password: '$2b$12$r1K/.F0HcjDXXA/SOFTRu.1Hq8RYxyHNLw84U6MCHB5GO4NszCxjW', role: 'contributor', domain: domainMap['Design'] },
      { username: 'culture_contributor', email: 'culture@company.com', password: '$2b$12$U0G49hBD1qDE8bGS/sDcdeR5mo0oOjiKspX6jHwH9cGP7nQOKUuja', role: 'contributor', domain: domainMap['Culture'] },
      { username: 'science_contributor', email: 'science@company.com', password: '$2b$12$s/JMO64.z0OMQgMCbHdHOupkyjsnyF8PoF5Hf5YYqEvJE5NGuoHcq', role: 'contributor', domain: domainMap['Science'] },
      { username: 'admin', email: 'admin@company.com', password: '$2b$12$nL/yH5uF25EO8xppFqzYkeubscnT651HE.tUJdKYXLn7Fxd5f0wQG', role: 'admin', domain: null },
      { username: 'user1', email: 'user1@company.com', password: '$2b$12$cwGnpqf.et9d1ZPog9.BweijrrjKX5uVMGBj6LQxODR/Va7RyCB0y', role: 'user', domain: null },
      { username: 'user2', email: 'user2@company.com', password: '$2b$12$cwGnpqf.et9d1ZPog9.BweijrrjKX5uVMGBj6LQxODR/Va7RyCB0y', role: 'user', domain: null }
    ];
