...
-- ⚠️ SECURITY WARNING: Passwords are stored as plain text in this file
-- For production, you MUST hash the passwords using bcrypt before importing
...
-- Insert users
-- ⚠️ SECURITY WARNING: These passwords are in plain text and MUST be hashed before using in production
INSERT INTO users (username, email, password, role, domain) VALUES
  ('hiring_manager', 'hiring@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', 'contributor', 'Hiring'),
  ('event_coordinator', 'events@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', 'contributor', 'Event'),
  ('journey_specialist', 'journey@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', 'contributor', 'Journey'),
  ('communication_manager', 'comm@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', 'contributor', 'Communication'),
  ('admin_contributor', 'admin.contributor@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', 'contributor', 'Admin'),
  ('admin', 'admin@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', 'admin', NULL),
  ('john_doe', 'john.doe@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', 'user', NULL),
  ('jane_smith', 'jane.smith@company.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.PZvO.S', 'user', NULL);
...
-- 3. After importing, you should immediately change all passwords in the production environment
-- 4. Make sure to set strong, unique passwords for each user account